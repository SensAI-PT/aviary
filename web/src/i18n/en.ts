const en: Record<string, string> = {
  ...
  "cluster.tab.rpc": "RPC",
  "cluster.tab.bench": "Bench",
  "cluster.bench.title": "Cluster bench (EPA harness)",
  "cluster.bench.subtitle": "Automated chat runs with usage wipe, job traces, and placement capture.",
  "cluster.bench.preset.cold": "Cold sequential",
  "cluster.bench.preset.warm": "Warm sequential",
  "cluster.bench.preset.concurrent": "Concurrent",
  "cluster.bench.preset.suite": "Run suite",
  "cluster.bench.wipeUsage": "Wipe usage (.coli_usage + master)",
  "cluster.bench.localOnly": "Local-only (empty experts map)",
  "cluster.bench.dropCaches": "Caches dropped (operator claim)",
  "cluster.bench.requests": "Requests",
  "cluster.bench.workers": "Workers",
  "cluster.bench.maxTokens": "Max tokens",
  "cluster.bench.usageNote": "Wipe clears file usage and master scheduler counts. Engine in-memory heat (eheat) is not reset — restart agents for a fully cold engine. --ram 2 is not starve: Linux page cache can still hold the checkpoint.",
  "cluster.bench.dropCachesNote": "True disk starve is Linux-only: as root on the Linux agent, run echo 3 > /proc/sys/vm/drop_caches between cold steps, or use a model that does not fit in page cache. The master never drops caches remotely — check the box only if you did it.",
  "cluster.bench.progress": "{{step}} · chat {{i}}/{{n}}",
  "cluster.bench.results": "Last result",
  "cluster.bench.copyMarkdown": "Copy markdown",
  "cluster.bench.copied": "Copied",
  "cluster.bench.metric": "Metric",
  "cluster.bench.value": "Value",
  "cluster.bench.hopMix": "Hop mix",
  "cluster.bench.step": "Step",
  "cluster.bench.ok": "OK",
