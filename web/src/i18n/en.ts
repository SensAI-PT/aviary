const en: Record<string, string> = {
  ...
  "cluster.bench.usageNote": "Wipe clears file usage and master scheduler counts. Engine in-memory heat (eheat) is not reset — restart agents for a fully cold engine.",
