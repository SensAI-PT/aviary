...
| `COLI_SSD_FAST_GBS` | `4.0` | Threshold (GB/s, measured F_NOCACHE, cached in `<model>/.coli_ssd`) at or above which the model volume counts as "fast" for the platform-aware Metal cache defaults (#379). |
